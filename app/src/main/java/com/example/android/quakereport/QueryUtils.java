...
public final class QueryUtils {
   ...
   public static ArrayList<Earthquake> extractEarthquakes() {
       ...
       // Try to parse the SAPMLE_JSON_RESPONSE. If there's a problem with the way the JSON
       ...
       try {
           ...
           for(int i = 0; i < earthquakeArray.length(); i++) {
               ...
               //Extract the value for the key called "mah"
               ...
               // Create a new Earthquake object with the magnitude, location, and time
           ...
           //If an error is thrown when excuting any of the above statements int the "try" blcok
